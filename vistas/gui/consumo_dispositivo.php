					...
					<div class="col-sm-4">
						<div class="card">
							<div class="card-body ">
								...
								<div class="row">
									<div class="col-5">
										<h3 class="card-title mt-2">[LG]</h3>
									</div>
									<div class="col-4">
										<h3 class="card-title mt-2 mr-4">Tele1</h3>
									</div>
									<div class="col-3">
					...
					<div class="col-sm-4">
						<div class="card">
							<div class="card-body ">
								...
								<div class="row">
									<div class="col-5">
										<h3 class="card-title mt-2">[Mademsa]</h3>
									</div>
									<div class="col-4">
					...
					<div class="col-sm-4">
						<div class="card">
							<div class="card-body ">
								...
								<div class="row">
									<div class="col-5">
										<h3 class="card-title mt-2">[HP]</h3>
									</div>
									<div class="col-4">
										<h3 class="card-title mt-2 mr-4">Impresora</h3>
									</div>
									<div class="col-3">
